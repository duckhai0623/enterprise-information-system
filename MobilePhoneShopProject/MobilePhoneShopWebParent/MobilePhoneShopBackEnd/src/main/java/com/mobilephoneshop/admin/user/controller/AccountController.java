...
public class AccountController
{
	...
	@GetMapping("/account")
	public String viewDetails(@AuthenticationPrincipal MobilePhoneShopUserDetails loggedUser,
			Model model)
	{
			...
			@RequestParam("image") MultipartFile multipartFile) throws IOException
	{
		...
		redirectAttributes.addFlashAttribute("message", "Chỉnh sửa thông tin cá nhân thành công!");
