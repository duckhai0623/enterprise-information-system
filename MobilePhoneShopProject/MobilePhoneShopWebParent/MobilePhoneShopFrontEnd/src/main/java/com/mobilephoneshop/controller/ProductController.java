package com.mobilephoneshop.controller;
...
import com.mobilephoneshop.category.CategoryService;
...
public class ProductController
{
	...
	// private AuthenticationControllerHelperUtil
	// authenticationControllerHelperUtil;
...
//
//			LOGGER.info(
//					"ProductController | viewCategoryByPage | listCategoryParents : " + listCategoryParents.toString());
//
...
//			{
//				LOGGER.info(
//						"ProductController | viewCategoryByPage | endCount > pageProducts.getTotalElements() | endCount : "
//								+ endCount);
//				LOGGER.info(
//						"ProductController | viewCategoryByPage | endCount > pageProducts.getTotalElements() | pageProducts.getTotalElements() : "
...
//
//			LOGGER.info(
//					"ProductController | viewProductDetail | listCategoryParents : " + listCategoryParents.toString());
...
//	public String searchByPage(@RequestParam("keyword") String keyword, @PathVariable("pageNum") int pageNum,
//			Model model)
//	{
//
...
//		{
//
//			LOGGER.info("ProductController | searchByPage | endCount > pageProducts.getTotalElements() | endCount : "
//					+ endCount);
//			LOGGER.info(
//					"ProductController | searchByPage | endCount > pageProducts.getTotalElements() | pageProducts.getTotalElements() : "
//							+ pageProducts.getTotalElements());
